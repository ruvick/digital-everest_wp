...
function my_assets()
{
	...
	wp_enqueue_style("blocks-library", get_template_directory_uri() . "/css/blocks-library.css", array(), $style_version, 'all'); //blocks-library (стили)
	...
	wp_enqueue_script('script', get_template_directory_uri() . '/js/script.min.js', array(), $scrypt_version, true); //fancybox
