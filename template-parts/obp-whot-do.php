			...
			<div class="why_need__inner">
				<div class="why_need__cool">
					<div class="why_need__card why_need__card_mini">
						<img src="<?php echo get_template_directory_uri();?>/img/obp-pie-chart.svg" alt="ОПТИМИЗАЦИЮ ВАШЕГО БИЗНЕСА">
				...
				<div class="why_need__cool">
					<div class="why_need__card why_need__card_mini">
						<img src="<?php echo get_template_directory_uri();?>/img/obp-stock-market.svg" alt="РАЗРАБОТАТЬ И ВНЕДРИТЬ ОПТИМАЛЬНОЕ АЙ-ТИ РЕШЕНИЕ">
				...
				<div class="why_need__cool">
					<div class="why_need__card why_need__card_mini">
						<img src="<?php echo get_template_directory_uri();?>/img/obp-diagram.svg" alt="ПОДГОТОВКУ ВАШЕГО БИЗНЕСА К МАСШТАБИРОВАНИЮ И РОСТУ">
